    ...
    <form class="m-5 formB" style="max-width: 45rem;" method="post" action="../Controller/process.php">
        ...
        <div class="form-row">
            ...
            <?php if(isset($_GET["kAdiErr"])): ?>
                <small style="color: black; border: thin solid yellow; border-radius: 100px; padding: 5px;background-color:yellow;" class="form-muted"><?= $_GET["kAdiErr"] ?></small>
            <?php endif; ?>
            ...
            <div class="form-group col-md-6">
                <?php if(isset($_GET["mailErr"])): ?>
                    <small  style="color: black; border: thin solid yellow; border-radius: 100px; padding: 5px;background-color:yellow;" class="form-muted eros"><?= $_GET["mailErr"] ?></small>
                <?php endif; ?><br>
            ...
            <div class="form-group col-md-6">
                <?php if(isset($_GET["passwdErr"])): ?>
                    <small style="color: black; border: thin solid yellow; border-radius: 100px; padding: 5px; background-color:yellow;" class="form-muted eros"><?= $_GET["passwdErr"] ?></small>
                <?php endif; ?><br>
        ...
        <div>
            ...
            <a href="../View/login.php" class="btn btn-secondary" style="margin-left: 50px">Login Page</a>
        </div>
    </form>
