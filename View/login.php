...
<form class="m-5 formB" style="max-width: 45rem;" action="../Controller/process.php" method="POST">
    ...
    <h1 class="h1-ticket h2" style="color: #0008;">Giriş Sayfasına Hoşgeldiniz</h1>

    <?php if(isset($_GET["errorKadi"])): ?>
    ...
    <div class="form-row">
        ...
        <div class="form-group col-md-6">
            ...
            <input type="password" class="form-control" id="sifre" name="sifre" placeholder="Password" required>
        </div>
    </div>
