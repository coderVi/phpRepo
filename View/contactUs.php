...
<html lang="en">
  ...
  <body style="background: linear-gradient(to right, blue , aqua); height:50%; background-size: cover; opacity: 0.9" >
    <!-- Navbar Side -->
    ...
    <form action="../Controller/mail.php" name="contactUs" style="padding: 10%; text-shadow: 2px 2px 5px red;" method="POST" id="contact-form">
        <input type="hidden" name="referer" value="bize ulaşın sayfası">
        ...
        <?php endif; ?>
        <h2 style="color:white; text-align: center;">Bize Ulaşın</h2>
        <input type="hidden">                
        <div class="row">
            ...
            <div class="col-md-12 input-area">
                <button type="submit" name="process" value="contact" class="btn btn-danger contact-submit-button">Gönder</button>
            </div>
        </div>
    </form>
    <!-- Footer Side -->
